...
if (!$conn) {
    ...
    $sql = "SELECT package.id, package.customer_id, package.receivername, package.receiverphone, locate_record.international_transportation, time_record.international_transportation
